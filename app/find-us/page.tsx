      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        {activeTab === 'location' && (
          <div className="space-y-8">
            {/* Address Card */}
            <div className="bg-white dark:bg-gray-800 rounded-2xl border-2 border-gray-300 dark:border-gray-600 shadow-lg p-8">
        ...
        {activeTab === 'contact' && (
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {/* Phone */}
              <div className="bg-white dark:bg-gray-800 rounded-2xl border-2 border-gray-300 dark:border-gray-600 shadow-lg p-6 text-center hover:shadow-xl transition-shadow">
